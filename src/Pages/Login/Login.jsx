...
const Login = () => {
      ...
      console.log('state in the location login page', location);
      ...
      return (
            <>
                  ...
                  <div className="hero min-h-screen bg-base-200">
                        <div className="hero-content flex-col w-1/2 md:flex-row lg:flex-row">
                              ...
                              <div className="card w-full flex-shrink-0 max-w-sm shadow-2xl bg-base-100">
                                    <form onSubmit={handleLogin} className="card-body">
                                          ...
                                          <div className="form-control mt-6">
                                                ...
                                                {/* TOGO: apply disable for recaptcha */}
